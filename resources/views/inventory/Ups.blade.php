       ...
       <x-sidebar />
        ...
        <div class="col-md-9">
            <div class="main-content bg-white p-4 rounded">
                ...
                <a href="{{ route('inventory.ups') }}" class="btn btn-secondary">
                    Clear Filters
                </a>
                @if (session('success'))
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($Ups as $index => $item)
                                <tr>
                                    <td>{{ $loop->iteration + ($Ups->currentPage() - 1) * $Ups->perPage() }}</td>
