    ...
    <div class="row mt-3">
        ...
        <div class="col-md-9">
            <div class="main-content bg-white p-4 rounded">
                ...
                <a href="{{ route('inventory.hub') }}" class="btn btn-secondary">
                    Clear Filters
                </a>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($hub as $index => $item)
                                <tr>
                                    <td>{{ $loop->iteration + ($hub->currentPage() - 1) * $hub->perPage() }}</td>
