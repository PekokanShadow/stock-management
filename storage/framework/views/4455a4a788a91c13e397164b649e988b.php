...
<body>
    <div class="qr-container">
        ...
        <div class="stock-number"><?php echo e($stocknumber); ?></div> <!-- Display the stock number beneath QR code -->
    </div>
    <a href="javascript:window.print()" class="print-button">Print QR Code</a>
</body>
</html><?php /**PATH P:\app\murni - Copy\inventory\resources\views/qrcode.blade.php ENDPATH**/ ?>