                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input 
                                            ...
                                            class="form-check-input"
                                            <?php if($role->permissions->pluck('name')->contains($permission->name)): ?> checked <?php endif; ?>
                                        >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH P:\app\murni - Copy\inventory\resources\views/profile/editrole.blade.php ENDPATH**/ ?>